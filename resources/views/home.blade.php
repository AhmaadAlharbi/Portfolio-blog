                            ...
                            <div class="col-span-12 space-y-2.5">
                                <div class="lg:mr-16">
                                    <p class="text-[#44566c] dark:text-color-910 leading-7">
                                        I am a computer engineer and web developer with over 3 years of experience in designing and developing dynamic, responsive websites and web applications. I am skilled in HTML, CSS, JavaScript, Bootstrap, TailwindCSS, Vue.js, PHP, and Laravel. I have a passion for solving problems and providing high-quality solutions that meet the needs of my clients. My ultimate goal is to be part of a team that continuously pushes the boundaries of what's possible in web development.</p>
